...
public class Ludo {
    ...
    static {
        ...
        paths.add(new ArrayList<>(Arrays.asList(
                ...
                new int[] { 4, 3 }, new int[] { 4, 2 }, new int[] { 3, 2 }, new int[] { 2, 2 }, new int[] { 2, 3 },
                new int[] { 3, 3 })));

        paths.add(new ArrayList<>(Arrays.asList(
                new int[] { 6, 6 }, new int[] { 6, 5 }, new int[] { 6, 4 }, new int[] { 6, 3 }, new int[] { 6, 2 },
                new int[] { 6, 1 },
        ...
        paths.add(new ArrayList<>(Arrays.asList(
                new int[] { 6, 0 }, new int[] { 5, 0 }, new int[] { 4, 0 }, new int[] { 3, 0 }, new int[] { 2, 0 },
                new int[] { 1, 0 },
                new int[] { 1, 1 }, new int[] { 1, 2 }, new int[] { 1, 3 }, new int[] { 1, 4 }, new int[] { 2, 4 },
                new int[] { 3, 4 }, new int[] { 4, 4 }, new int[] { 4, 3 }, new int[] { 4, 2 }, new int[] { 3, 2 },
                new int[] { 2, 2 }, new int[] { 2, 3 }, new int[] { 3, 3 }))); // <- Corrected semicolon added here
    }
